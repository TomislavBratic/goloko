    ...
    return (
        <header className="w-full p-2 max-h-12 flex justify-between items-center bg-[#E3A933] shadow-md">
            <div className="flex items-center">
                <img src="/centered_bird_logo.png" className="w-35 h-35 mt-6 hover:scale-110 transition:300 z-1"></img>
            </div>
            <nav className="space-x-4">
                ...
                <button onClick={toggleDarkMode} className="ml-4 mr-1 px-2 py-1 border rounded-md text-sm text-gray-100
